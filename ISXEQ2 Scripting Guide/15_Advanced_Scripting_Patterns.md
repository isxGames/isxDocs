...
- Door automation, aggro-pause integration, and CPU-saving pulse throttling
- Complete working examples (single-region, multi-waypoint, and combat-aware navigation)
