...
7. [Examine Window Interaction](#examine-window-interaction)
8. [Collection Processing](#collection-processing)
9. [Raid Attendance Tracking](#raid-attendance-tracking)
