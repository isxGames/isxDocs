...
3. [Console Output and Echo](#console-output-and-echo)
4. [File-Based Logging](#file-based-logging)
...
8. [ISXEVE Debugging Tools](#isxeve-debugging-tools)
...
14. [Entity and Targeting Problems](#entity-and-targeting-problems)
15. [Module and Ship Control Issues](#module-and-ship-control-issues)
16. [Navigation and Movement Problems](#navigation-and-movement-problems)
17. [Inventory and Cargo Issues](#inventory-and-cargo-issues)
18. [Fleet and Relay Problems](#fleet-and-relay-problems)
19. [Performance and Memory Issues](#performance-and-memory-issues)
20. [Configuration Problems](#configuration-problems)
21. [ISXEVE Bugs and Limitations](#isxeve-bugs-and-limitations)
22. [Common Scripting Mistakes](#common-scripting-mistakes)
23. [Recovery and Failsafe Strategies](#recovery-and-failsafe-strategies)
24. [Debugging Workflows](#debugging-workflows)
25. [Production Deployment Issues](#production-deployment-issues)
