...
15. [Decision Trees for Architecture Choice](#decision-trees-for-architecture-choice)
16. [Complete Working Example: Mining Bot](#complete-working-example-mining-bot)

### Decision Making and Logic
17. [Decision Making and Logic Patterns](#decision-making-and-logic-patterns)
18. [Decision-Making Overview](#decision-making-overview)
19. [Target Selection Patterns](#target-selection-patterns)
20. [Priority Systems](#priority-systems)
21. [Condition Checking Patterns](#condition-checking-patterns)
22. [Decision Trees](#decision-trees)
23. [Weighted Scoring Systems](#weighted-scoring-systems)
24. [Real Examples from Bots (Decision)](#real-examples-from-bots)
25. [Mining Decision Logic](#mining-decision-logic)
26. [Combat Decision Logic](#combat-decision-logic)
27. [Movement Decision Logic](#movement-decision-logic)
28. [Common Patterns (Decision)](#common-patterns)
29. [Performance Considerations (Decision)](#performance-considerations-1)

### Error Handling and Recovery
30. [Error Handling and Recovery](#error-handling-and-recovery)
31. [Error Handling Overview](#error-handling-overview)
32. [Types of Errors](#types-of-errors)
33. [Error Detection Patterns](#error-detection-patterns)
34. [Logging Patterns](#logging-patterns)
35. [Recovery Strategies](#recovery-strategies)
36. [Retry Logic](#retry-logic)
37. [Graceful Degradation](#graceful-degradation)
38. [Emergency Procedures](#emergency-procedures)
39. [Common Errors and Solutions](#common-errors-and-solutions)
40. [Failsafes and Sanity Checks](#failsafes-and-sanity-checks)
41. [Real Examples from Bots (Error)](#real-examples-from-bots-1)

### Performance and Timing
42. [Performance and Timing](#performance-and-timing)
43. [Performance Overview](#performance-overview)
44. [Timing Fundamentals](#timing-fundamentals)
45. [Loop Optimization](#loop-optimization)
46. [Query Optimization](#query-optimization)
47. [Caching Strategies](#caching-strategies)
48. [CPU Usage Management](#cpu-usage-management)
49. [Memory Management](#memory-management)
50. [Profiling and Measurement](#profiling-and-measurement)
51. [Common Performance Bottlenecks](#common-performance-bottlenecks)
52. [Optimization Patterns](#optimization-patterns)
53. [Real Examples from Bots (Performance)](#real-examples-from-bots-2)
54. [Performance Checklist](#performance-checklist)
