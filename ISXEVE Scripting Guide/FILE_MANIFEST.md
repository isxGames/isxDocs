...
Detailed per-file descriptions of each numbered guide have been moved to README.md to avoid duplication. See the **Documentation Structure** section in README.md for the canonical narrative summaries of all 22 guide files.
