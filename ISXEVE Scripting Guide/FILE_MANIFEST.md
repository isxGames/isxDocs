...
**Topics:** Main loops, decision patterns, error handling, performance
...
**Topics:** LGUI migration, XML to JSON, conversion patterns
...
**Topics:** Fleet coordination, Yamfa analysis, relay systems, multi-boxing
