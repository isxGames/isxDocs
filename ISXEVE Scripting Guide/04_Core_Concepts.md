...
6. [Mining and Resources](#mining-and-resources)
7. [NPCs and Anomalies](#npcs-and-anomalies)
8. [Stations and Structures](#stations-and-structures)
9. [Fleet Mechanics](#fleet-mechanics)
10. [Standings and Security](#standings-and-security)
11. [Critical Timing and Delays](#critical-timing-and-delays)

### InnerSpace Platform
12. [InnerSpace Platform Overview](#innerspace-platform-overview)
13. [What Is InnerSpace](#what-is-innerspace)
14. [Architecture and Components](#architecture-and-components)
15. [LavishScript Engine](#lavishscript-engine)
    - [Metaprogramming: GetFallthroughObject](#metaprogramming-getfallthroughobject)
16. [Extension System](#extension-system)
17. [Sessions and Multi-Client](#sessions-and-multi-client)
18. [Uplink and Relay](#uplink-and-relay)
19. [Script Execution Model](#script-execution-model)
20. [Console and Commands](#console-and-commands)
21. [File System and Paths](#file-system-and-paths)
22. [Performance and Limitations (InnerSpace)](#performance-and-limitations)

### ISXEVE Extension
23. [ISXEVE Extension Architecture](#isxeve-extension-architecture)
24. [What Is ISXEVE](#what-is-isxeve)
25. [How ISXEVE Works](#how-isxeve-works)
26. [Core Object Hierarchy](#core-object-hierarchy)
27. [Object Types and TLOs](#object-types-and-tlos)
28. [Members vs Methods](#members-vs-methods)
29. [Entity System](#entity-system)
30. [UI Interaction](#ui-interaction)
31. [Event System](#event-system)
32. [Common Patterns](#common-patterns)
33. [Limitations and Constraints](#limitations-and-constraints)
